...
<div class="container mb-5">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <!-- Title -->
            <h1 class="mt-4">My Story</h1>

            <hr>

            <!-- Post Content -->
            <p class="lead"><strong>My name is Chyngyz Omorov. I'm 22 years old. I come from Kyrgyzstan. I study
                    Software Engineering at Bahcesehir University.</strong></p>

            <p>I'm interested in electronics, robotics and AI.</p>

            <blockquote class="blockquote">
                <p class="mb-0">If you want to go somewhere, it is best to find someone who has already been there.</p>
